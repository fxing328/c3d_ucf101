...
if __name__ =='__main__':
    caffe.set_mode_gpu()
    net = caffe.Net('./c3d_ucf101_my_train_test1.prototxt','/scratch/xf362/c3d_ucf101/model1/test_new_57000.000000',caffe.TEST)
   # iteration = 2788
    iteration = 4
#    pos = []
 #   neg = []
    ...
    pkl.dump(testRes_fc6,open("feature_c3d_test_fc6tt","wb"))
    testRes_fc7['data'] = data_fc7
    testRes_fc7['label'] = label
    pkl.dump(testRes_fc7,open("feature_c3d_test_fc7tt","wb"))
    testRes_fc8['data'] = data_fc8
    testRes_fc8['label'] = label
    pkl.dump(testRes_fc8,open("feature_c3d_test_fc8tt","wb"))
