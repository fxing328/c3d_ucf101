...
if __name__=='__main__':
    ...
    #caffe.set_device(0)
    caffe.set_mode_gpu()
    solver = caffe.SGDSolver('c3d_ucf101_large_sovler.prototxt')

    #solver.net.copy_from('/scratch/ys1297/caffe-installation/model/verizon/')
    solver.net.copy_from('/scratch/xf362/c3d_ucf101/model1/test_new_26000.000000')
    ...
    #with open('c3d_ucf101_my_train_large_log.txt','a') as txt_file:
    #	for it in range(niter):
    #        solver.step(1)  # SGD by Caffea	
    #        pdb.set_trace()
    #        train_loss[it] = solver.net.blobs['loss'].data
    #        #print 'train_loss'+ str(train_loss[it])
    #        print 'train_loss'+ str(train_loss[it]) + " std :" + str(solver.net.params['fc8'][0].data.std()) +"iteration: " +str(it+26000)
    ...
    #    	txt_file.write('iteration: '+ str(it+26000)+  ' test_loss: '+str(loss/100) +'\n')		
    #           # txt_file.close()         
    #       	solver.net.save('model1/test_new_%f'%(it+26000))
    # 
